	...
	private void OnClicked () {
		...
		case ButtonType.GearUp:
				...
				if (RCC_SceneManager.Instance.activePlayerVehicle)
				{
					...
					{
						GamePlay_Manager.Instance.ReverseON();

						//RCC_SceneManager.Instance.activePlayerVehicle.ChangeGear(-1);
						GamePlay_Manager.Instance.GearDown.SetActive(true);
						GamePlay_Manager.Instance.GearUp.SetActive(false);
					}else
                    {
						Gameplay.instance.GearDown.SetActive(true);
						Gameplay.instance.GearUp.SetActive(false);
					}
		...
		case ButtonType.GearDown:
				...
				if (RCC_SceneManager.Instance.activePlayerVehicle)
				{
					...
					if (SceneManager.GetActiveScene().name == "GamePlay")
					{
						GamePlay_Manager.Instance.ReverseOFF();

						//RCC_SceneManager.Instance.activePlayerVehicle.GearShiftDown();
						GamePlay_Manager.Instance.GearDown.SetActive(false);
						GamePlay_Manager.Instance.GearUp.SetActive(true);
					}else
                    {
						Gameplay.instance.GearDown.SetActive(false);
						Gameplay.instance.GearUp.SetActive(true);
					}
